...
public abstract class PublishToNexusMCTask extends DefaultTask {
    ...
    @Input
    public abstract Property<String> getResourceId();
    ...
    @Input
    @Optional
    public abstract Property<VersionTag> getVersionTag();

    @Input
    @Optional
    public abstract Property<String> getVersionTitle();
    ...
    @Input
    public abstract Property<String> getDownloadType();

    @Input
    public abstract ListProperty<String> getMcVersions();

    @Input
    public abstract ListProperty<String> getSubcategoryIds();
